...
const faqs = [
  { q: "How much does a website cost?", a: "Our starter website starts from R500 once-off (1 page) or R1,000 (5 pages) — plus R250/month hosting to keep it live. Full ownership packages start from R2,500. We have a plan for every budget." },
