...
const packages = [
  ...
  },
  {
    ...
    price: "R5,000",
    suffix: "",
    description: "Advanced solution with custom design and enhanced functionality.",
    features: [
      "4–6 page website",
  ...
  },
  {
    ...
    price: "R9,000",
    suffix: "+",
    description: "Fully customized, scalable platform with all the bells and whistles.",
    features: [
