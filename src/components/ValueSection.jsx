        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground font-dm text-base sm:text-lg leading-[1.8] font-light">
              We prove our expertise by showing you real work first — like our <strong className="text-foreground font-medium">Bright Future Holders / SkillWise</strong> platform: a fully functional, MICT SETA-accredited training site with course management, e-commerce, student reviews, and authentication. That's not a demo — it's live. Our professional websites starting at <strong className="text-primary font-medium">R2,500</strong> deliver the same quality and attention to detail. Every site includes SSL security, mobile optimization, SEO setup, hosting, and free 30-day support. You're not just buying a website — you're partnering with a team that cares about your success.
            </p>
