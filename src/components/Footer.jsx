...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-border/50 pt-12 sm:pt-16 pb-8 overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-10 mb-10 sm:mb-12 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="tel:0823562239"
                className="w-9 h-9 rounded-xl bg-secondary border border-border/50 flex items-center justify-center hover:bg-secondary/80 transition-all duration-300"
                aria-label="Phone"
              >
              ...
              {links.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-sm font-inter text-muted-foreground hover:text-primary transition-all duration-200 flex items-center gap-1.5 group"
                  >
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="space-y-3">
              <a href="tel:0823562239" className="flex items-center gap-3 text-sm font-inter text-muted-foreground hover:text-primary transition-all duration-200 group">
              ...
              <a href="tel:0820610949" className="flex items-center gap-3 text-sm font-inter text-muted-foreground hover:text-primary transition-all duration-200 group">
                <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                  <Phone className="w-3.5 h-3.5" />
                </div>
                082 061 0949
              </a>
              <a href="mailto:poomeigh503@gmail.com" className="flex items-center gap-3 text-sm font-inter text-muted-foreground hover:text-primary transition-all duration-200 group">
                <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center group-hover:bg-primary/10 transition-colors">
        ...
        {/* Bottom bar */}
        <div className="pt-6 sm:pt-8 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
